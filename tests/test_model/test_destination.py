...
class TestDestination:
    ...
    def test_bulk_sync_conflict_resolution(
        self,
        destination: DestinationPostgreSQL,
    ) -> None:
        ...
        assert (
            float(result[0]) == expected_value
        ), "Conflict resolution did not update value correctly"
