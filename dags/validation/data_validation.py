...
class DataValidator(Validator):
    ...
    def validate(self) -> bool:
        ...
        run_id = RunIdentifier(
            run_name="Ingestion time scan",
            run_time=pendulum.now("UTC").strftime("%Y%m%dT%H%M%S.%f"),
        )
        ...
        completeness_result = self.context.checkpoints.get(
    ...
    def doc(self) -> None:
        ...
        logging.info(
            f"Data Docs available at: {self.context.get_docs_sites_urls()[0]['site_url']}",
        )
